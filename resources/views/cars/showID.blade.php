            ...
            <div class="container_table">
                              <table>
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                      <td data-title='Provider Name'>
                                          رقم السيارة وحرف السيارة ومحافظة اللوحة وصنف العجلة
                                      </td>
                                      <td data-title='Provider Name'>
                                          {{$car->car_number}} <space></space> {{$car->car_letter}} <space></space>{{$car->government_car}} <space></space>{{$car->number_type}}
                                      </td>
                                  </tr>
                                  <tr>
                                      <td data-title='Provider Name'>
                ...
                <div class="slider_img">
                    <div class="content">
                        <div class="images">
                            <img src="{{asset('/gas-system.odcsmart.com/storage/app/public/'. $car->id_card_photo)}}" alt="">
                            <img src="{{asset('/gas-system.odcsmart.com/storage/app/public/'. $car->car_photo)}}"  alt="">
                            <img src="{{asset('/gas-system.odcsmart.com/storage/app/public/'. $car->resident_card_photo)}}" alt="">
                            <img src="{{asset('/gas-system.odcsmart.com/storage/app/public/'. $car->document_front_photo)}}" alt="">
                            <img src="{{asset('/gas-system.odcsmart.com/storage/app/public/'. $car->document_back_photo)}}" alt="">
                            <img src="{{asset('/gas-system.odcsmart.com/storage/app/public/'. $car->id_card_photo2)}}" alt="">
                            <img src="{{asset('/gas-system.odcsmart.com/storage/app/public/'. $car->resident_card_photo2)}}" alt="">
